...
router.patch('/:id', (0, auth_1.default)(user_1.ENUM_USER_ROLE.ADMIN), (0, validateRequest_1.default)(user_validations_1.UserValidation.update), user_controller_1.UserController.updateIntoDB);
